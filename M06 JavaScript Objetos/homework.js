...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var x = {nombre:nombre, edad:edad, meow:()=>{return "Meow"}
           }return x();
}
...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   var x = {nombre:nombre,email:email,password:password}
   return x
}
...
function tienePropiedad(objeto, propiedad) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   //for(key in objeto){ if(key === propiedad){return true}return false;}
...
//Usuario{
posts: [post={post:likes,post2:likes,post3:likes}]
}
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
   var suma = 0;
   for(var i in objetoUsuario.posts.post.likes){
      suma += objetoUsuario.posts.post.likes[i]
   }return suma;
}
